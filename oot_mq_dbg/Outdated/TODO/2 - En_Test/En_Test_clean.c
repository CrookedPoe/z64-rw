...
void data_8085F658(void); /* 2 internal, 8 external, 149 lines */
void data_8085F8A0(void); /* 0 internal, 5 external, 40 lines */
...
void data_80864048(void); /* 0 internal, 4 external, 72 lines */
...
void data_80863694(void); /* 1 internal, 5 external, 85 lines */
...
const uint32_t data_80864510[] =
{
	...
	0x00320000,
	0x00000928,
	(uint32_t)(void*)data_8085F658,
	(uint32_t)(void*)data_8085F8A0,
	(uint32_t)(void*)data_80863694,
	(uint32_t)(void*)data_80864048
};
...
void data_8085F8A0(void) /* 0 internal, 5 external, 40 lines */
{
	...
	asm(
		...
		"swc1            $f4,16($sp)                            \n"
		"bnel            $v0,$zero,.L000004                     \n"
		"or              $a0,$s1,$zero                          \n"
		"jal             external_func_800F5B58                 \n"
		"nop                                                    \n"
		".L000003:                                              \n"
		"or              $a0,$s1,$zero                          \n"
		".L000004:                                              \n"
		"jal             external_func_8002709C                 \n"
		"lw              $a1,2060($s0)                          \n"
		"or              $a0,$s1,$zero                          \n"
