...
typedef struct z64_skelanime_s z64_skelanime_s, *Pz64_skelanime_s;
...
struct z64_skelanime_s { /* Skeleton and Animation Drawing Structure */
    uint8_t limb_count; /* Number of Limbs in Object Hierarchy */
    uint8_t unk_00_; /* Undocumented / Unused */
    uint8_t dlist_count; /* Number of Limbs that use Display Lists in Object Hierarchy */
    uint8_t unk_01_; /* Undocumented / Unused */
    uint32_t limb_index; /* RAM Address of Object Limb Index */
    uint32_t anim_current; /* Currently Loaded Animation */
    char unk_02_[4]; /* Undocumented / Unused */
    float anim_frame_count; /* Frame Count of anim_current */
    float unk_03_; /* Undocumented / Unused */
    float anim_current_frame; /* Current Animation Frame */
    float anim_playback_speed; /* Speed of Animation Playback */
    void * draw_table_start; /* Actor Drawing Table Start Address */
    void * draw_table_end; /* Actor Drawing Table End Address */
    char unk_05_[4]; /* Undocumented / Unused */
    float unk_06_;
    void * draw_table_func; /* external_func_800A4EE0 */
    char unk_07[16]; /* Undocumented / Unused */
};
