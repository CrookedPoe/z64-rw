[-] zzcovl v0.01  <z64.me> (based on zovldis by Kjartan Skjervoy <kskjer@gmail.com> and Rhett Osborne <rmo@spinout182.com>)
[-] Built: Jul 14 2019 16:35:05
[-] Input file: En_Tubo_Trap_oot.zovl
[-] Start address 0x80B258F0.
...
/*** function prototypes ***/
void data_80B264AC(void); /* 0 internal, 1 external, 13 lines */
void data_80B25990(void); /* 0 internal, 1 external, 10 lines */
...
const uint32_t data_80B264E0[] =
{
	...
	0x00030000,
	0x000001AC,
	(uint32_t)(void*)data_80B258F0,
	(uint32_t)(void*)data_80B25990,
	(uint32_t)(void*)data_80B263F4,
	(uint32_t)(void*)data_80B264AC,
	0x00000000,
};
...
void data_80B258F0(void) /* 0 internal, 5 external, 40 lines */
{
	...
	asm(
		...
		"lui             $a3,0x4000                             \n"
		"lui             $a0,%hi(data_80B26530)                 \n"
		"jal             external_func_80002130                 \n"
		"addiu           $a0,$a0,%lo(data_80B26530)             \n"
		"lui             $a0,%hi(data_80B26534)                 \n"
		"addiu           $a0,$a0,%lo(data_80B26534)             \n"
		"jal             external_func_80002130                 \n"
		"lh              $a1,28($s0)                            \n"
		"addiu           $a1,$s0,352                            \n"
		"sw              $a1,32($sp)                            \n"
		...
		"lw              $a0,44($sp)                            \n"
		"lui             $a3,%hi(data_80B264E0)                 \n"
		"lw              $a1,32($sp)                            \n"
		"addiu           $a3,$a3,%lo(data_80B264E0)             \n"
		"lw              $a0,44($sp)                            \n"
		...
		"or              $a0,$s0,$zero                          \n"
		"lui             $t6,%hi(data_80B2612C)                 \n"
		"addiu           $t6,$t6,%lo(data_80B2612C)             \n"
		"sw              $t6,332($s0)                           \n"
		"lw              $ra,28($sp)                            \n"
		"lw              $s0,24($sp)                            \n"
		"addiu           $sp,$sp,40                             \n"
